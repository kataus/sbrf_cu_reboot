...
//    notifyWrap();
  ...
  private static void simpleWrap() throws IOException {
    ...
    var currentDir = new File("./l32-multiprocess/src/main/java");
    new ProcessBuilder("java", "ru.sbrf.cu.processrunner.Job")
        .inheritIO()
  ...
  private static void monitorWrap() throws IOException, InterruptedException {
    ...
    var procBuilder = new ProcessBuilder("java", "ru.sbrf.cu.processrunner.Job")
        .directory(currentDir);
  ...
  private static void notifyWrap() throws IOException {
    ...
    var currentDir = new File("./l32-multiprocess/files");
