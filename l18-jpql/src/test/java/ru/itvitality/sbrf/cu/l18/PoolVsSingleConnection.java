...
@Testcontainers
public class PoolVsSingleConnection {
    private static final Logger logger = LoggerFactory.getLogger( PoolVsSingleConnection.class );
    ...
    public void doSelect( boolean usePool ) throws SQLException {
        if ( usePool ) {
            makeConnectionPool();
        }
