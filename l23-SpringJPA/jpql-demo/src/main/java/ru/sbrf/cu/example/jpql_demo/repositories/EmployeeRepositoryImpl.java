package ru.sbrf.cu.example.jpql_demo.repositories;

import org.springframework.stereotype.Repository;
import ru.sbrf.cu.example.jpql_demo.dto.CitySalary;
import ru.sbrf.cu.example.jpql_demo.dto.EmployeeProjects;
...
public class EmployeeRepositoryImpl implements EmployeeRepository {
    ...
    public List<CitySalary> calcAvgSalaryByCities() {
        return em.createQuery(
                "select new ru.sbrf.cu.example.jpql_demo.dto.CitySalary(e.address.city, avg(e.salary)) " +
                        "from Employee e " +
    ...
    public List<EmployeeProjects> findEmployeesProjectsCount() {
        return em.createQuery(
                "select new ru.sbrf.cu.example.jpql_demo.dto.EmployeeProjects(e, count(p)) " +
